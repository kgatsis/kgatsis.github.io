...
function bibtex_js_draw() {
 ...
 (new BibtexDisplay()).displayBibtex($("#bibtex_input_conf").val(), $("#bibtex_display_conf"));
  (new BibtexDisplay()).displayBibtex($("#bibtex_input_workshop").val(), $("#bibtex_display_workshop"));
 (new BibtexDisplay()).displayBibtex($("#bibtex_input_report").val(), $("#bibtex_display_report"));
}
